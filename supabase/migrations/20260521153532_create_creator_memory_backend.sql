...
drop index if exists creator_memory_profiles_id_key;
...
create index if not exists creator_memory_profiles_user_id_idx on public.creator_memory_profiles(user_id);
