...
export default function RadarComingSoonClient() {
  ...
  return (
    <main className="relative isolate min-h-[calc(100dvh-4.25rem)] overflow-x-hidden bg-[#020611] px-4 pb-[calc(6rem+env(safe-area-inset-bottom))] pt-3 text-white lg:px-6 min-[1280px]:pb-[calc(1rem+env(safe-area-inset-bottom))]">
      <div
        aria-hidden="true"
      ...
      <div className="mx-auto flex w-full max-w-[780px] flex-col gap-3">
        <section className="relative min-h-[430px] overflow-hidden rounded-[22px] border border-violet-200/[0.16] bg-[linear-gradient(145deg,rgba(24,18,52,0.84),rgba(5,10,24,0.88)_42%,rgba(4,9,21,0.9))] p-5 shadow-[0_18px_58px_rgba(0,0,0,0.4)] backdrop-blur-2xl min-[430px]:min-h-[410px] min-[1280px]:min-h-[274px]">
          <div
            aria-hidden="true"
          ...
          <div className="relative z-10 flex w-[78%] max-w-[25rem] flex-col items-start min-[430px]:w-[74%] min-[1280px]:w-auto">
            ...
            <p className="mt-5 text-[0.72rem] font-bold uppercase tracking-[0.27em] text-violet-300">
              Radar tendances
            </p>
            <h1 className="mt-2 text-[2.3rem] font-black leading-[0.96] tracking-[-0.055em] text-zinc-50 min-[430px]:text-[2.5rem] min-[1280px]:text-[2.45rem]">
              Repère les signaux
              <br />
              avant saturation.
            </h1>
            <p className="mt-4 max-w-[23rem] text-[0.94rem] leading-[1.42] text-zinc-300 min-[1280px]:text-[0.92rem]">
            ...
            <div className="mt-5 flex w-full max-w-[24rem] flex-col gap-2">
              <WaitlistButton onClick={notifyLaunch} label="Me prévenir au lancement" />
              <Link
                href="/dashboard"
                className="inline-flex h-11 items-center justify-center rounded-[13px] border border-white/[0.12] bg-white/[0.035] px-4 text-[0.9rem] font-semibold text-zinc-200 shadow-[inset_0_1px_0_rgba(255,255,255,0.06)] transition hover:border-white/20 hover:bg-white/[0.06] focus:outline-none focus-visible:ring-2 focus-visible:ring-violet-300/70 min-[1280px]:h-10 min-[1280px]:text-[0.82rem]"
              >
                Retour au dashboard
              </Link>
            </div>
        ...
        <section className="overflow-hidden rounded-[22px] border border-white/[0.1] bg-white/[0.035] p-4 shadow-[0_18px_54px_rgba(0,0,0,0.32)] backdrop-blur-2xl">
        ...
        <section className="relative overflow-hidden rounded-[24px] border border-fuchsia-200/20 bg-[linear-gradient(135deg,rgba(82,49,231,0.92),rgba(185,42,162,0.88)_48%,rgba(232,74,154,0.82))] p-4 shadow-[0_18px_54px_rgba(147,51,234,0.25)]">
          ...
          <div className="relative z-10 grid gap-3 min-[430px]:flex min-[430px]:items-center min-[430px]:justify-between">
            <div className="grid min-w-0 grid-cols-[auto_1fr] items-center gap-3">
              <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-[16px] border border-white/20 bg-[#1d1447]/40 text-violet-100 shadow-[inset_0_1px_0_rgba(255,255,255,0.12)] min-[430px]:h-14 min-[430px]:w-14">
                <RadarIcon name="bell" className="h-6 w-6 min-[430px]:h-7 min-[430px]:w-7" />
              </div>
              <div className="min-w-0">
                <h2 className="text-[1.05rem] font-black leading-tight tracking-[-0.02em] text-white min-[430px]:text-lg">
                  Sois prévenu dès l’ouverture du Radar.
                </h2>
                <p className="mt-1 max-w-[24rem] text-[0.8rem] leading-5 text-violet-100/80 min-[430px]:text-sm">
            ...
            <button
              ...
              className="inline-flex h-11 w-full shrink-0 items-center justify-center gap-2 rounded-[14px] border border-white/10 bg-[#160d27]/85 px-4 text-[0.9rem] font-bold text-white shadow-[0_14px_34px_rgba(0,0,0,0.22)] transition hover:bg-[#1d1234]/90 focus:outline-none focus-visible:ring-2 focus-visible:ring-white/70 min-[430px]:w-auto min-[430px]:min-w-[10rem] min-[430px]:px-5"
            >
              Me prévenir
...
function WaitlistButton({ onClick, label }: { onClick: () => void; label: string }) {
  return (
    <button
      type="button"
      onClick={onClick}
      className="group inline-flex h-12 items-center justify-center gap-2.5 rounded-[14px] bg-[linear-gradient(135deg,#5b4bff_0%,#c13ee5_48%,#f04f9d_100%)] px-4 text-[0.92rem] font-bold text-white shadow-[0_16px_38px_rgba(192,62,229,0.26)] transition hover:brightness-110 focus:outline-none focus-visible:ring-2 focus-visible:ring-fuchsia-200/80 active:scale-[0.99] min-[1280px]:h-11 min-[1280px]:text-[0.84rem]"
    >
...
function HeroRadarVisual() {
  return (
    <div className="pointer-events-none absolute -right-[5.2rem] top-[5.25rem] z-0 h-[16rem] w-[16rem] opacity-[0.68] min-[430px]:-right-12 min-[430px]:top-16 min-[430px]:h-[17rem] min-[430px]:w-[17rem] min-[1280px]:right-2 min-[1280px]:top-4 min-[1280px]:h-[17.5rem] min-[1280px]:w-[17.5rem] min-[1280px]:opacity-[0.85]">
...
function RadarVisualization() {
  return (
    <div className="relative mt-3 h-[286px] overflow-hidden rounded-[20px] border border-white/[0.08] bg-[linear-gradient(180deg,rgba(7,13,32,0.88),rgba(5,8,18,0.94))] shadow-[inset_0_1px_0_rgba(255,255,255,0.05)] min-[430px]:h-[306px] min-[1280px]:h-[255px]">
      ...
      <svg aria-hidden="true" viewBox="0 0 720 330" preserveAspectRatio="xMidYMid slice" className="absolute inset-0 -top-1 h-[83%] w-full min-[430px]:h-[86%] min-[1280px]:h-full">
        <defs>
      ...
      <div className="absolute bottom-3 left-3 right-3 rounded-[18px] border border-white/[0.12] bg-[#11172a]/76 p-2.5 text-center shadow-[0_18px_50px_rgba(0,0,0,0.32)] backdrop-blur-xl min-[430px]:left-6 min-[430px]:right-6 min-[1280px]:left-10 min-[1280px]:right-10 min-[1280px]:p-3">
        <p className="text-[0.62rem] font-black uppercase tracking-[0.28em] text-zinc-200 min-[430px]:text-[0.68rem] min-[1280px]:text-[0.72rem]">
          Bientôt dans Viralynz
        </p>
        <div className="mt-2 grid grid-cols-3 gap-1.5 min-[1280px]:gap-2">
          {radarChips.map((chip) => (
            <div key={chip.label} className="min-w-0 rounded-[14px] border border-white/[0.1] bg-white/[0.055] px-1.5 py-2 text-left shadow-[inset_0_1px_0_rgba(255,255,255,0.06)] min-[430px]:px-2 min-[1280px]:rounded-[15px] min-[1280px]:px-2.5 min-[1280px]:py-2.5">
              <div className="flex items-center gap-1.5">
                <span className={`h-2 w-2 shrink-0 rounded-full ${chip.color}`} />
                <span className="whitespace-nowrap text-[0.68rem] font-bold leading-4 text-zinc-100 min-[430px]:text-[0.76rem] min-[1280px]:text-sm">{chip.label}</span>
              </div>
              <p className="mt-0.5 whitespace-nowrap pl-3.5 text-[0.58rem] leading-4 text-zinc-400 min-[430px]:text-[0.66rem] min-[1280px]:text-xs">{chip.caption}</p>
            </div>
          ))}
        </div>
      </div>
...
function FeatureList() {
  return (
    <section className="rounded-[22px] border border-white/[0.1] bg-white/[0.035] p-2.5 shadow-[0_18px_54px_rgba(0,0,0,0.3)] backdrop-blur-2xl min-[1280px]:p-3">
      {featureItems.map((item, index) => (
        <div
          key={item.title}
          className={`group flex items-center gap-3 rounded-[16px] px-2 py-3 transition hover:bg-white/[0.035] min-[1280px]:px-3 ${
            index < featureItems.length - 1 ? 'border-b border-white/[0.075]' : ''
          }`}
        >
          <div className={`flex h-11 w-11 shrink-0 items-center justify-center rounded-[13px] bg-gradient-to-br ${item.tone} ring-1 shadow-[inset_0_1px_0_rgba(255,255,255,0.08)] min-[1280px]:h-12 min-[1280px]:w-12`}>
            <RadarIcon name={item.icon} className="h-5 w-5 min-[1280px]:h-6 min-[1280px]:w-6" />
          </div>
          <div className="min-w-0 flex-1">
            <h3 className="text-[1rem] font-black leading-5 tracking-[-0.015em] text-zinc-50 min-[1280px]:text-lg">
              {item.title}
            </h3>
            <p className="mt-0.5 text-[0.86rem] leading-5 text-zinc-400 min-[1280px]:text-base">{item.description}</p>
          </div>
          <RadarIcon name="arrow" className="h-4 w-4 shrink-0 text-zinc-500 transition group-hover:translate-x-0.5 group-hover:text-zinc-300 min-[1280px]:h-5 min-[1280px]:w-5" />
        </div>
      ))}
    </section>
  )
