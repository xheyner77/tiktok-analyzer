  ...
  return (
    <main className="min-h-screen bg-vn-void overflow-x-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none" aria-hidden>
        <div className="absolute -top-40 left-1/2 -translate-x-1/2 w-[900px] h-[500px] rounded-full bg-gradient-to-b from-vn-fuchsia/8 to-transparent blur-3xl" />
        ...
        <div className="max-w-6xl mx-auto px-5 sm:px-8 lg:px-10">
          ...
          <div className="grid md:grid-cols-3 gap-4 sm:gap-5">
            {coreFeatures.map((feat) => (
              <div
                key={feat.title}
                className={`relative p-6 sm:p-7 rounded-2xl border ${feat.border} bg-gradient-to-b ${feat.accent} overflow-hidden group hover:-translate-y-0.5 transition-all duration-300`}
              >
                {/* Top accent line */}
