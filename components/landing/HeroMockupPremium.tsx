...
export default function HeroMockupPremium() {
  return (
    ...
    >
      ...
      <motion.div {...from(20, 0, 0.5)} className="absolute -top-4 -right-6 lg:-right-10 z-20">
      ...
      <motion.div {...from(18, 0, 0.75)} className="absolute top-[9rem] -right-4 lg:-right-12 z-20">
      ...
      <motion.div {...from(0, 20, 0.7)} className="absolute -bottom-12 -right-4 lg:-right-10 z-20 w-[175px]">
      ...
      <motion.div {...from(-20, 0, 0.6)} className="absolute -bottom-7 -left-4 lg:-left-10 z-20">
        <div className="mock-float-b">
