export const productPositioningEngine = {
  ...
  premiumCopy: [
    'Operate your short-form pipeline from one AI command center.',
    'Turn every analysis into a reusable creator intelligence asset.',
    'Know what to post, repost, test, and stop doing.',
  ],
};
