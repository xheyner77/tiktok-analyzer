...
export const changelogEntries: ChangelogEntry[] = [
  {
    ...
    date: '11 mai 2026',
    isoDate: '2026-05-11',
    title: 'Plans Starter, Pro et Lifetime alignés avec Stripe',
    summary:
      'La monétisation est maintenant cohérente entre la landing, le checkout Stripe, les quotas produit et les plans annuels Pro / Lifetime.',
    category: 'Billing & Plans',
    tags: ['Pricing', 'Stripe', 'Starter', 'Pro', 'Lifetime'],
    status: 'live',
    items: [
      { type: 'Produit', text: 'Nouveaux plans : Starter à 10€, Pro à 29€ et Lifetime à 149€.' },
      { type: 'Nouveauté', text: 'Ajout des versions annuelles Pro et Lifetime avec prix mensuel équivalent affiché clairement.' },
      { type: 'Amélioration', text: 'Checkout Stripe aligné sur les plans Starter, pro et Lifetime avec intervalle mensuel ou annuel.' },
      { type: 'Correction', text: 'Nettoyage des anciens libellés de plans pour ne garder que Starter, Pro et Lifetime.' },
      { type: 'Amélioration', text: 'Quotas harmonisés : Starter pour démarrer, Pro pour Lifetimer, Lifetime pour équipes et volume.' },
    ],
  },
  {
    version: 'v1.5.0',
    ...
    items: [
      ...
      { type: 'Amélioration', text: 'Plan Lifetime correctement reconnu depuis Supabase et affiché dans Dashboard V2.' },
  ...
  },
  {
    ...
    items: [
      ...
      { type: 'Amélioration', text: 'Radar réservé aux plans Pro et Lifetime pour garder une hiérarchie d’offre claire.' },
  ...
  },
  {
    ...
    category: 'Starter OS',
    tags: ['Dashboard V2', 'TikTok Accounts', 'Starter Memory', 'Repost'],
    status: 'live',
    items: [
      ...
      { type: 'Produit', text: 'Starter Memory pour commencer à identifier forces, faiblesses et patterns récurrents.' },
